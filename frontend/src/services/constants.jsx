...
export const deliveryAreas = {
  ...
  'Financial District': [
    { value: 'NSE', label: 'Nairobi Securities Exchange', fee: 150 },
    { value: 'KICC', label: 'KICC', fee: 150 },
    { value: 'CENTRAL_BANK', label: 'Central Bank of Kenya', fee: 150 }
  ],
  'Kiambu County': [
  ...
  'Machakos County': [
    { value: 'MACHAKOS', label: 'Machakos Town', fee: 300 },
    { value: 'ATHI_RIVER', label: 'Athi River (Mavoko)', fee: 300 },
    { value: 'SYOKIMAU', label: 'Syokimau', fee: 300 },
    { value: 'KATANI', label: 'Katani', fee: 300 }
  ],
  'Kajiado County': [
